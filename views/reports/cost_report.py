...
def cost_report():
    ...
    if profit_ym:
        ...
        cogs_focus = cogs_by_month.get(profit_ym) or 0

        if selected_store_id:
            # store-specific first, then global fallback
        ...
        if profit_setting_row:
            ...
            profit_est = {
                ...
                "fixed_cost_yen": int(fixed),
                "setting_store_id": profit_setting_row["store_id"],
